            ...
            menus: [
                {
                    ...
                    itens: [
                        {
                            icone: 'fa fa-list',
                            titulo: 'Listagem/Edição dos Hoteis',
                            url: '/listar-hotel'
                        },
                        {
                            icone: 'fa fa-file-lines',
                            titulo: 'Cadastro de Hotel',
                            url: '/cadastrar-hotel'
                        },
                    ]
                },
                {
                    icone: 'fa fa-bed',
                    titulo: 'Reserva e Hospede',
                    itens: [
                        {
                            icone: 'fa fa-list',
                            titulo: 'Listagem/Edição de Reserva e Hospede',
                            url: '/listar-reserva-hospede'
                        },
                        {
                            icone: 'fa fa-file-lines',
                            titulo: 'Cadastro de Reserva ',
                            url: '/cadastrar-reserva-hospede'
                        },
                    ]
                },
